...
public class AuthServerThread extends Thread {
    ...
    public static String recordDir = "src/main/resources/AuthServerRecords.txt";

    public AuthServerThread(DatagramSocket _socket, byte[] _messageByte, InetAddress _address, int _port) {
        this.socket = _socket;
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("SENDING RESPONSE TO " + this.address + ":" + this.port);
